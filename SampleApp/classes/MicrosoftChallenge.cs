                            ...
                            foreach (string characteristic in characteristics)
                            {
                                ...
                                // {
                                    for (int k = 2; k > -1; k--) {
                                        ...
                                        {
                                            string message = $"searching our dog {ourAnimals[i, 3]} for {characteristic} {icon} {k.ToString()}";
                                            Console.Write($"\r{message.PadRight(Console.WindowWidth)}"); // Ensures complete overwrite
                                            Thread.Sleep(100);
                                        }
                                    }
